...
shared_ptr<Film> FactorySQL::genererFilm(string id, string titre, string lien, int annee, string affiche, string synopsis) {
	...
	string sql = "SELECT nom, prenom, id_film, id_personne, id_video, id_acteur" + 
	...
	//on récupère tous les acteurs liés au film depuis la base
	sql = "SELECT nom, prenom, id_film, id_personne, id_video, id_real" + 
		  " FROM Films,Personnes,Realisateurs" + 
		  " WHERE id_episode = '" + id + "' AND Films.id_film = Realisateurs.id_video AND Personnes.id_personne = Realisateurs.id_real;";
...
shared_ptr<Episode> FactorySQL::genererEpisode(string id, string titre, string lien, int annee, int numero, int saison, string serie, string synopsis) {
	...
	//on récupère tous les acteurs liés au film depuis la base
	string sql = "SELECT nom, prenom, id_episode, id_personne, id_video, id_acteur " + 
	...
	//on fait la même chose avec les réalisateurs
	//on récupère tous les acteurs liés au film depuis la base
	sql = "SELECT nom, prenom, id_episode, id_personne, id_video, id_real" + 
