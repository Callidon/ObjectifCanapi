...
*/
shared_ptr<Video> FactorySQL::genererFilm(string id, string titre, string lien, int annee, string affiche, string synopsis) {
	shared_ptr<Video> nouveauFilm (new Film(id, titre, lien, annee, affiche, synopsis));
